...
const nav = [
  ...
  { href: '/loads', label: 'Load Board', icon: Truck },
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-5 py-5 border-b border-[#1A2235]">
        ...
        <div>
          <div className="text-sm font-semibold text-white leading-none">Load</div>
          <div className="text-xs text-[#8B95A5] mt-0.5">Dispatch</div>
        </div>
      </div>
