...
export default function NavBar() {
  return (
    <nav className="border-b border-warp-border bg-warp-card/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-warp-accent-muted flex items-center justify-center">
            <Truck className="w-4 h-4 text-warp-accent" />
          </div>
          <div>
            <span className="font-semibold text-white text-sm">Deadhead Calculator</span>
